...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder (ENV['PROJECT_DIR'] || ENV['PROJECT_DIR'] = '../hawker'), '/home/vagrant/projects/hawker'
  ...
  # SHELL
  #config.vm.provision :shell, path: #'~/projects/vagrant/node-vagrant/scripts/bootstrap.sh'
end
